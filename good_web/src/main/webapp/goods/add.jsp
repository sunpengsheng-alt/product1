...
<script type="text/javascript" src="${pageContext.request.contextPath }/bootstrap/js/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
	...
	<script type="text/javascript">
        ...
        function checkName(value) {
            $.ajax({
                methods:"get",
                url:"http://localhost:8080/goods/checkName/"+value,
                success:function (data) {
                    var str = $("#checkName");
...
<body>
	<div class="container">
		<div class="panel panel-default">
			...
			<!-- 商品添加form表单 -->
			<form action="${pageContext.request.contextPath}/goods/addCategory" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="goodsName" value="" class="form-control" id="goodsName" placeholder="商品名称" onblur="checkName(this.value)">
									</div>
									<div id="checkName">
